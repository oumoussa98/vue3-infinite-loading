<template>
  <div class="font-sans antialiased text-ui-typo bg-ui-background mx-auto">
    <div class="flex flex-col justify-start min-h-screen">
      ...
      <main class="relative flex flex-wrap justify-start flex-1 w-full bg-ui-background px-2">
        <aside
          v-if="hasSidebar"
          class="sidebar"
...
strong,
blockquote {
  @apply mb-4 text-sm text-ui-typo;
}
